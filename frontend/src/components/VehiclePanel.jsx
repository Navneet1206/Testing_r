    ...
    return (
        <div>
            ...
            <div onClick={() => {
                ...
                <div className='-ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>7-Seater <span><i className="ri-user-3-fill"></i>1</span></h4>
                    <h5 className='font-medium text-sm'>3 mins away </h5>
                    <p className='font-normal text-xs text-gray-600'>Affordable Family SUV</p>
                </div>
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>11-Seater <span><i className="ri-user-3-fill"></i>3</span></h4>
                    <h5 className='font-medium text-sm'>3 mins away </h5>
                    <p className='font-normal text-xs text-gray-600'>Affordable Mini bus</p>
                </div>
